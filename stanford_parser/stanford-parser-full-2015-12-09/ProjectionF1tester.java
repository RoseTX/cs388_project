...
public class ProjectionF1tester extends LexicalizedParser{
    ...
    public ProjectionF1tester(Lexicon lex, BinaryGrammar bg, UnaryGrammar ug, DependencyGrammar dg, Index<String> stateIndex, Index<String> wordIndex, Index<String> tagIndex, Options op) {
    ...
    public static void main(String[] args) {
       ...
       weights[4] = 0.002;
        ...
        System.out.println("------------------------");
        System.out.println("Projection error F1: " + pcfgLBf.getEvalbF1Percent());
        System.out.println("------------------------");
